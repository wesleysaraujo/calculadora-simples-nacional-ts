...
const Anexo2_1 = require("../../../src/Core/Entities/Anexos/Anexo2");
const AbstractAnexo_1 = require("../../../src/Core/Support/AbstractAnexo");
test('Instanciar Anexo 1', function () {
    const anexo2 = new Anexo2_1.Anexo2();
    expect(anexo2).toBeInstanceOf(Anexo2_1.Anexo2);
    expect(anexo2).toBeInstanceOf(AbstractAnexo_1.AbstractAnexo);
});
